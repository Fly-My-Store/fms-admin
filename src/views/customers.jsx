...
export default function CustomersView() {
  ...
  const { rows, totalPages, totalCount, setPageIndex, setPageSize } = useAxiosPaginatedList('admin/iam/users', {
    params: listParams,
  ...
  return (
    <CustomersTableSection
      rows={rows}
      handleEditButton={(row) => row?.id && router.push(`/customers/edit/${row.id}`)}
      handleViewButton={(row) => row?.id && router.push(`/customers/${row.id}`)}
