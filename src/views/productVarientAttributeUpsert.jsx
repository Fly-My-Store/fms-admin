...
import { getVariantAttr, listDefs, upsertVariantAttr } from 'api/attributes';
...
export default function ProductVariantAttributeUpsert() {
  ...
  async function handleSubmit() {
    try {
      ...
      const payload = { status: form.status, variant_id: form.variant_id, attributeCode: form.attribute_code };
