...
import __TABLE__ from 'sections/variant-barcodes/VariantBarcodesTableSection';
import __FORM__ from 'sections/variant-barcodes/VariantBarcodesFormDialog';
import axiosServices from 'utils/axios';

export default function VariantBarcodesView() {
  ...
  const load = async () => {
    try {
      const resp = await axiosServices.get('admin/catalog/variant-barcodes', { params: { page: pageIndex + 1, limit: pageSize } });
