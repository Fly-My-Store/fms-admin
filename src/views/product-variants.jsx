...
import __TABLE__ from 'sections/product-variants/ProductVariantsTableSection';
import __FORM__ from 'sections/product-variants/ProductVariantsFormDialog';
...
export default function ProductVariantsView() {
  ...
  const load = async () => {
    try {
      const resp = await axiosServices.get('admin/catalog/product-variants', { params: { page: pageIndex + 1, limit: pageSize } });
