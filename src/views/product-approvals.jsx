...
import __TABLE__ from 'sections/product-approvals/ProductApprovalsTableSection';
import __FORM__ from 'sections/product-approvals/ProductApprovalsFormDialog';
import axiosServices from 'utils/axios';

export default function ProductApprovalsView() {
  ...
  const load = async () => {
    try {
      const resp = await axiosServices.get('admin/catalog/products?status=PROPOSED', { params: { page: pageIndex + 1, limit: pageSize } });
