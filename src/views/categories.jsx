...
import CategoriesFormDialog from 'sections/categories/CategoriesFormDialog';
...
export function CategoriesView() {
  ...
  useEffect(() => {
    dispatch(catalog.categoriesListRequest({ params: { page, limit: pageSize } }));
  }, [dispatch]);
  ...
  const handlePaginationChange = (updater) => {
    ...
    dispatch(catalog.categoriesListRequest({ params: { page: next.pageIndex + 1, limit: next.pageSize } }));
  };
  ...
  return (
    <>
      ...
      />
      <CategoriesFormDialog open={open} onClose={handleDialogToggle} initialData={selected} />
    </>
  );
}
