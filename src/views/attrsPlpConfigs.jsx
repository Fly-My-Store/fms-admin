...
export function PlpconfigsView() {
  ...
  const list = state.plpConfigs || { rows: [], meta: { page: 1, pageSize: 20, totalPages: 1 }, loading: false, error: null };
  ...
  const handlePaginationChange = (updater) => {
    ...
    dispatch(attributes.plpConfigsListRequest({ params: { page: next.pageIndex + 1, limit: next.pageSize } }));
  };
