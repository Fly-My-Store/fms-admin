...
import WebhookeventsFormDialog from 'sections/webhookEvents/WebhookeventsFormDialog';
...
export function WebhookeventsView() {
  ...
  return (
    <>
      ...
      />
      <WebhookeventsFormDialog open={open} onClose={handleDialogToggle} initialData={selected} />
    </>
  );
}

export default WebhookeventsView;
