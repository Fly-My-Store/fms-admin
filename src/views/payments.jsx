...
export function PaymentsView() {
  ...
  useEffect(() => {
    dispatch(ordersPayments.paymentsListRequest({ params: { page, limit: pageSize } }));
  }, [dispatch]);
  ...
  const handlePaginationChange = (updater) => {
    ...
    dispatch(ordersPayments.paymentsListRequest({ params: { page: next.pageIndex + 1, limit: next.pageSize } }));
  };
