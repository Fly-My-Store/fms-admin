...
import __TABLE__ from 'sections/product-attributes/ProductAttrsTableSection';
import __FORM__ from 'sections/product-attributes/ProductAttrsFormDialog';
import axiosServices from 'utils/axios';

export default function ProductAttrsView() {
  ...
  const load = async () => {
    try {
      const resp = await axiosServices.get('admin/catalog/product-attributes', { params: { page: pageIndex + 1, limit: pageSize } });
